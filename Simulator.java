...
public interface Simulator {
    ...
    public static String place = "san francisco";    // To change the destination
    ...
    public static String descriptions = "on";   // Whether     or not the user see's the step-by-step of each state. "on" or "off" respectively.
    ...
    public static int simulations = 5;        // How many times the simulation is run.
    ...
    public static int showSuggestionsAfter = 3;
    ...
    public static double lookCost = 1;
